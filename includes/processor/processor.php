...
switch ($action) {
	...
	case "checkWallet":
		...
		$query="INSERT INTO wallets_found (private_key, public_key, wallet_address, dictionary_word, current_balance, received_bitcoins) VALUES ('$private','$public','$guessAddr','$guess','$balance','$received') ON DUPLICATE KEY UPDATE current_balance=VALUES(current_balance), received_bitcoins=VALUES(received_bitcoins)";
